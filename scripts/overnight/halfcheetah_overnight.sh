#!/bin/bash
# HalfCheetah 환경 Overnight 실험 스크립트
# 실행: chmod +x scripts/overnight/halfcheetah_overnight.sh && bash scripts/overnight/halfcheetah_overnight.sh
...
for algo in "${algorithms[@]}"; do
    ...
    python -m main multi --config config/halfcheetah/${algo}.yaml --num_workers 3
