...
echo "=========================================="
python -m main multi --config config/cartpole_ppo_wandb.yaml --seeds 0 1 2 --num_workers 1
...
echo "=========================================="
python -m main multi --config config/cartpole_trpo_wandb.yaml --seeds 0 1 2 --num_workers 1
